...
namespace CofeShopManagment
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Romi\Documents\cofeshop.mdf;Integrated Security=True;Connect Timeout=30");
        public RegisterForm()
        {
            InitializeComponent();
        }
        ...
        private void register_btn_Click(object sender, EventArgs e)
        {
            if (emptyFields())
            {
                MessageBox.Show("All fields are required to be filled.", "Error Massage", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkUsername = new SqlCommand(selectUsername, connect)) 
                        {
                            ...
                            if (table.Rows.Count >= 1)
                            {
                                ...
                                MessageBox.Show(usern + "is alredy exist","Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }
